...
local loadedscript = game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/functions/viciousbeeserverhop.lua")
...
local Cookie = loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/functions/auth"))()()
