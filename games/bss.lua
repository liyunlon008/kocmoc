...
getgenv().api = loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/api.lua"))()
local bssapi = loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/bssapi.lua"))()
...
loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/functions/premium/loadperks.lua"))()
...
--loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/functions/premium/loadperks.lua"))()("WindowLoad",Window)
...
farmo:CreateDropdown("自动挖掘模式", {"正常","收集器偷盗"}, function(Option)  kocmoc.vars.autodigmode = Option end)

local contt = farmtab:CreateSection("容器工具")
contt:CreateToggle("不要转换花粉", nil, function(State) kocmoc.toggles.disableconversion = State end)
contt:CreateToggle("自动减袋",nil,function(Boole) kocmoc.toggles.autouseconvertors = Boole end)
contt:CreateDropdown("袋子减少模式",{"票证转换器","只有雪花","只有椰子","雪花和椰子","门票和雪花","门票和椰子","全部"},function(Select) kocmoc.vars.autouseMode = Select end)
contt:CreateSlider("减量确认时间",3,20,10,false,function(tttttttt) kocmoc.vars.autoconvertWaitTime = tonumber(tttttttt) end)

farmo:CreateToggle("自动洒水器", nil, function(State) kocmoc.toggles.autosprinkler = State end)
farmo:CreateToggle("农场泡沫", nil, function(State) kocmoc.toggles.farmbubbles = State end)
farmo:CreateToggle("农场火焰", nil, function(State) kocmoc.toggles.farmflame = State end)
farmo:CreateToggle("农场椰子和淋浴", nil, function(State) kocmoc.toggles.farmcoco = State end)
farmo:CreateToggle("农场精密十字准线", nil, function(State) kocmoc.toggles.collectcrosshairs = State end)
farmo:CreateToggle("农场模糊炸弹", nil, function(State) kocmoc.toggles.farmfuzzy = State end)
farmo:CreateToggle("气球下农场", nil, function(State) kocmoc.toggles.farmunderballoons = State end)
farmo:CreateToggle("云下农场", nil, function(State) kocmoc.toggles.farmclouds = State end)
farmo:CreateLabel("")
farmo:CreateToggle("自动蜂蜜面具",nil,function(bool)
    kocmoc.toggles.honeymaskconv = bool
end)
farmo:CreateDropdown("默认面具",MasksTable,function(val)
...
local farmt = farmtab:CreateSection("农业")
farmt:CreateToggle("自动售货机 [⚙]", nil, function(State) kocmoc.toggles.autodispense = State end)
farmt:CreateToggle("自动助推器 [⚙]", nil, function(State) kocmoc.toggles.autoboosters = State end)
farmt:CreateToggle("自动财富时钟", nil, function(State) kocmoc.toggles.clock = State end)
...
farmt:CreateToggle("自动播种机", nil, function(State) kocmoc.toggles.autoplanters = State end):AddToolTip("将在转换后重新种植您的花盆，如果达到100%")
...
farmt:CreateToggle("自动免费蚂蚁通行证", nil, function(State) kocmoc.toggles.freeantpass = State end)
farmt:CreateToggle("农场苗芽", nil, function(State) kocmoc.toggles.farmsprouts = State end)
farmt:CreateToggle("农场泡泡菌", nil, function(State) kocmoc.toggles.farmpuffshrooms = State end)
-- BEESMAS MARKER farmt:CreateToggle("Farm Snowflakes [⚠️]", nil, function(State) kocmoc.toggles.farmsnowflakes = State end)
farmt:CreateToggle("传送到稀有 [⚠️]", nil, function(State) kocmoc.toggles.farmrares = State end)
farmt:CreateToggle("自动接受/确认请求 [⚙]", nil, function(State) kocmoc.toggles.autoquest = State end)
farmt:CreateToggle("自动执行任务 [⚙]", nil, function(State) kocmoc.toggles.autodoquest = State end)
farmt:CreateToggle("自动蜂蜜风暴", nil, function(State) kocmoc.toggles.honeystorm = State end)
farmt:CreateLabel(" ")
...
serverhopkill:CreateButton("Vicious Bee Serverhopper [⚠️][📜]",function() loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/liyunlon008/kocmoc@main/functions/viciousbeeserverhop.lua"))() end):AddToolTip("Serverhops for rouge vicious bees")
